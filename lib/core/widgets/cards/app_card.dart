    ...
    final card = Material(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(borderRadius),
          border:
              border ?? Border.all(color: scheme.outlineVariant, width: 1.w),
        ),
...
class _HorizontalContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        if (leading != null) ...[leading!, SpacerWidget.widthCustom(12)],
        Expanded(
          child: Column(
        ...
        if (trailing != null) ...[SpacerWidget.widthCustom(12), trailing!],
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        Expanded(child: Column(children: [base, SpacerWidget.small(), base])),
        SpacerWidget.widthCustom(12),
        Container(
          width: 24.w,
          height: 24.h,
